...
// const socials = [
//   { name: "Behance", href: "https://www.behance.net/Lahiru_Jayasinghe" },
//   { name: "LinkedIn", href: "https://www.linkedin.com/in/lahiru-rajakaruna-jayasinghe/" },
//   // { name: "Instagram", href: "https://www.instagram.com/lahiru_rj/" },
...
//             <motion.a
//               href="mailto:lahiruj367@gmail.com"
//               initial={{ opacity: 0, y: 20 }}
//               animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }}
...
//             <form 
//               className="space-y-6" 
//               action="https://formspree.io/f/mojklzag" 
//               method="POST"
//             >
//               <div className="grid gap-6 sm:grid-cols-2">
//                 <div>
...
export function Contact() {
  ...
  const sendEmail = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (formRef.current) {
      emailjs
        .sendForm(
          "service_rf88pmg",   // <-- Replace with your EmailJS Service ID
          "template_fvr70wk",  // <-- Replace with your EmailJS Template ID
          formRef.current,
          "T5Id1ZkA5obuV83ib"    // <-- Replace with your EmailJS Public Key
        )
        .then(
          (result) => {
          ...
          >
            ...
            >
              ...
              <motion.button
                ...
                className="w-full rounded-full bg-primary px-8 py-4 text-sm font-medium text-primary-foreground disabled:opacity-70 disabled:cursor-not-allowed"
              >
