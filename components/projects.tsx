...
const allProjects = [
  {
    ...
    image: "/projects/project-1.png",
    year: "2024",
    link: "https://www.behance.net/gallery/209452349/Richmond-College-Cricket-Site" 
  },
  {
    title: "Bus Booking Mobile App",
    category: "UI/UX Design",
    ...
    image: "/projects/project-2.jpg",
    year: "2022",
    link: "https://www.behance.net/gallery/201951515/Bus-Booking-Mobile-App"
  },
  {
    title: "DEBONAIR",
    category: "UI/UX Design",
    ...
    image: "/projects/project-3.png",
    year: "2020",
    link: "https://www.behance.net/gallery/201888963/DEBONAIR-(Resturant-UI-Design-)"
  },
  {
    title: "Facebook Posts",
    category: "Graphic Design",
    ...
    image: "/projects/project-4.jpg",
    year: "2024",
    link: "https://www.behance.net/gallery/213372439/FaceBook-Posts"
  },
]
  ...
  return (
    ...
    >
      ...
      <div className="relative mb-5 overflow-hidden rounded-2xl bg-card aspect-[4/3]">
        ...
        >
          <div className="flex w-full items-end justify-between">
            <p className="max-w-sm text-sm leading-relaxed text-foreground pointer-events-none">
              {project.description}
            </p>
            ...
            >
              <motion.div
                ...
                whileTap={{ scale: 0.9 }}
                className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-primary cursor-pointer shadow-lg"
              >
                <svg
                  width="20"
                  height="20"
